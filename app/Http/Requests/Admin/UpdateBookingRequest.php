...
class UpdateBookingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status'             => 'sometimes|in:confirmed,pending,cancelled,completed,deposit-paid,fully-paid',
            'payment_status'     => 'sometimes|in:pending,deposit-paid,fully-paid',
            'group_type'         => 'sometimes|in:private,group',
