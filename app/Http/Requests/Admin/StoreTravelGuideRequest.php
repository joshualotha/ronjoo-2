...
class StoreTravelGuideRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('content')) {
            ...
            // Allow legacy string content; normalize to blocks.
    ...
    public function rules(): array
    {
        return [
            ...
            'slug'             => 'required|string|max:255|unique:travel_guides,slug',
            'category'         => 'required|string|max:100',
            'guide_type'       => 'required|string|max:50',
